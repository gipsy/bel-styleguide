module AssetHelper
  ...
  def static_ui_stylesheet (stylesheet, secure)
    if secure
      path = "https://secure.bellroy.com/static-ui/style/#{stylesheet}.css"
    else
      path = "http://static.bellroy.com/static-ui/style/#{stylesheet}.css"
    end
    capture_haml do
  ...
  def static_ui_script (script, secure)
    if secure
      path = "https://secure.bellroy.com/static-ui/js/#{script}.js"
    else
      path = "http://static.bellroy.com/static-ui/js/#{script}.js"
    end
    capture_haml do
